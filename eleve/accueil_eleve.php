...
<ul class="cd-accordion margin-top-lg margin-bottom-lg">
  <li class="cd-accordion__item cd-accordion__item--has-children">
    ...
    <label class="cd-accordion__label cd-accordion__label--icon-folder" for="group-1"><span class='GP GP1'>GP 1 : <?php echo(nom_gp(1));?> </span><span class='barre'>Moyenne : <?php $moyenne_gp=moyenne_gp_eleve(1,$email);echo($moyenne_gp); ?> Barre :   <?php echo(barre_gp(1));?> Grade : <?php grade_gp(1,$email);?></span>
  ...
  <li class="cd-accordion__item cd-accordion__item--has-children">
    ...
    <ul class="cd-accordion__sub cd-accordion__sub--l1">
      <li class="cd-accordion__item cd-accordion__item--has-children">
        ...
        <label class="cd-accordion__label cd-accordion__label--icon-folder" for="sub-group-13"><span class='UP'>UP 1 : <?php echo(nom_up(1,4))?> </span><span class='moyenne'>Moyenne :  <?php echo(moyenne_up_eleve(13,$email))?>   Coefficient : <?php echo(coef_up(1,4))?>  Barre : <?php echo(barre_up(1,4))?> </span></label>
      ...
      <li class="cd-accordion__item cd-accordion__item--has-children">
        ...
        <label class="cd-accordion__label cd-accordion__label--icon-folder" for="sub-group-14"><span class='UP'>UP2 : <?php echo(nom_up(2,4))?></span><span class='moyenne'>Moyenne : <?php echo(moyenne_up_eleve(14,$email))?>   Coefficient : <?php echo(coef_up(2,4))?>  Barre : <?php echo(barre_up(2,4))?></span></label>
        <ul class="cd-accordion__sub cd-accordion__sub--l2">
          <li class="cd-accordion__item"><span class='note'>NOTE 1 : Moyenne :</span></a></li>
          <li class="cd-accordion__item"><span class='note'>NOTE 2 : Moyenne :</span></a></li>
          <li class="cd-accordion__item"><span class='note'>NOTE 3 : Moyenne :</span></a></li>
    ...
    <li class="cd-accordion__item cd-accordion__item--has-children">
        ...
        <label class="cd-accordion__label cd-accordion__label--icon-folder" for="sub-group-15"><span class='UP'>UP3 : <?php echo(nom_up(3,4))?></span><span class='moyenne'>Moyenne : <?php echo(moyenne_up_eleve(15,$email))?>   Coefficient : <?php echo(coef_up(3,4))?>  Barre : <?php echo(barre_up(3,4))?></span></label>
        <ul class="cd-accordion__sub cd-accordion__sub--l2">
          <li class="cd-accordion__item"><span class='note'>NOTE 1 : Moyenne :</span></a></li>
          <li class="cd-accordion__item"><span class='note'>NOTE 2 : Moyenne :</span></a></li>
          <li class="cd-accordion__item"><span class='note'>NOTE 3 : Moyenne :</span></a></li>
    ...
    <li class="cd-accordion__item cd-accordion__item--has-children">
        ...
        <label class="cd-accordion__label cd-accordion__label--icon-folder" for="sub-group-16"><span class='UP'>UP4 : <?php echo(nom_up(4,4))?></span><span class='moyenne'>Moyenne :  <?php echo(moyenne_up_eleve(16,$email))?>  Coefficient : <?php echo(coef_up(4,4))?>  Barre : <?php echo(barre_up(4,4))?></span></label>
        <ul class="cd-accordion__sub cd-accordion__sub--l2">
          <li class="cd-accordion__item"><span class='note'>NOTE 1 : Moyenne :</span></a></li>
          <li class="cd-accordion__item"><span class='note'>NOTE 2 : Moyenne :</span></a></li>
          <li class="cd-accordion__item"><span class='note'>NOTE 3 : Moyenne :</span></a></li>
